  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden bg-tradingview-dark-darker">
      ...
      <div className="container mx-auto px-4 py-20 text-center relative z-10">
        <motion.h1
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter mb-6 text-tradingview-dark-text"
        ...
        <motion.h2
          className="text-2xl md:text-3xl mb-8 text-tradingview-secondary"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
