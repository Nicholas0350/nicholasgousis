...
export function AboutSection() {
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-tgv-dark-darker via-tgv-dark-bg to-tgv-dark-darker border-b border-tgv-dark-border">
      ...
      <div className="absolute inset-0 w-full h-full bg-grid-small-white/[0.7]">
      ...
      <div className="flex flex-col md:flex-row mx-auto px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto backdrop-blur-sm bg-tgv-dark-darker/30 p-8 rounded-2xl border border-tgv-dark-border/50">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-2/3">
              <h2 className="font-heading text-[2.5rem] font-bold tracking-[-0.04em] mb-8 text-tgv-dark-text">
                About Nicholas Gousis
              </h2>
              <div className="space-y-6">
                <p className="font-heading text-[1.125rem] tracking-[-0.02em] text-tgv-dark-text">
                ...
                <p className="font-heading text-[1.125rem] tracking-[-0.02em] text-tgv-secondary">
                ...
                <div className="flex flex-wrap gap-4 mt-6">
                  <div className="px-4 py-2 bg-tgv-dark-darker rounded-full border border-tgv-dark-border">
                    <span className="font-heading text-[0.875rem] tracking-[-0.02em] text-tgv-primary">Ex-Floor Trader</span>
                  </div>
                  <div className="px-4 py-2 bg-tgv-dark-darker rounded-full border border-tgv-dark-border">
                    <span className="font-heading text-[0.875rem] tracking-[-0.02em] text-tgv-primary">AI Expert</span>
                  </div>
                  <div className="px-4 py-2 bg-tgv-dark-darker rounded-full border border-tgv-dark-border">
                    <span className="font-heading text-[0.875rem] tracking-[-0.02em] text-tgv-primary">Financial Advisor</span>
                  </div>
                </div>
              </div>
            </div>
