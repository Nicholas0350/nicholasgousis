  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden bg-tradingview-dark-darker">
      ...
      <div className="absolute inset-0 w-full h-full bg-grid-small-white/[0.2]">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-tradingview-dark-darker/50 via-transparent to-tradingview-dark-darker/50" />
        <div className="absolute inset-0 bg-gradient-to-t from-tradingview-dark-darker/50 via-transparent to-tradingview-dark-darker/50" />
      </div>

      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-tradingview-dark-text">About Nicholas Gousis</h2>
          <div className="space-y-6">
            <p className="text-lg text-tradingview-dark-text">
            ...
            <p className="text-lg text-tradingview-secondary">
